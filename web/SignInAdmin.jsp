<%-- 
    ...
    Created on : May 15, 2024, 8:23:01 PM
    Author     : ADMIN
--%>
                        ...
                        <div class="wrap d-md-flex">
                            <div class="text-wrap p-4 p-lg-5 text-center d-flex align-items-center order-md-last">
                                <div class="text w-100">
                                    <h2>Welcome site manager</h2>
                                    <p>Wishing you good management</p>
                                    <a href="signin" class="btn btn-white btn-outline-white">Back to SignIn for user</a>
                                </div>
                            </div>
                            <div class="login-wrap p-4 p-lg-5">
                                ...
                                <form action="signinadmin" method="post" class="signin-form">
