        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div  class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="request" class="nav-item nav-link active">List Request</a>
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    <a href="home.jsp" class="nav-item nav-link">Home</a>
                    <a href="#" class="nav-item nav-link">Messenger</a>
                    <a href="${pageContext.request.contextPath}/request" class="nav-item nav-link active">List Request</a>
                    <a href="Contact.jsp" class="nav-item nav-link active">Contact</a>
                </div>
            </div>
