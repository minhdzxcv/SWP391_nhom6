...
<%@include file="footer.jsp" %>
        ...
        <script>
            ...
            // Check if the 'createCV' element exists
if (document.getElementById('createCV') != null) {
    document.getElementById('createCV').onclick = function () {
        // Check if the body style does not already include 'overflow: hidden;'
        if (!document.body.style.overflow.includes("hidden")) {
            // Apply new styles to the body
            document.body.style.cssText = 'overflow: hidden; padding-right: 17px; background-color: rgb(233, 235, 238) !important; padding-top: 66px;';
            
            // Create and append the modal to the body
            let modal = document.createElement('div');
            modal.innerHTML = `<div role="dialog">
                                    <div class="container"></div>
                                    <div role="dialog" tabindex="-1" class="" style="display: block;">
                                        <div class="main-body">
                                            <div class="row" role="document">
                                                <div class="col-lg-4">
                                                    <div class="logo">
                                                        <img alt="logo playerduo" style="border-radius: 20%;" src="images/logo.png">
                                                        <h1>Happy Programming</h1>
                                                    </div>
                                                    <div class="card">
                                                        <form method="post">
                                                            <div class="form-control">
                                                                <input type="text" name="ProfessionIntro" placeholder="Profession Introduction" maxlength="255" autocomplete="off" required>
                                                            </div>
                                                            <div class="form-control">
                                                                <input type="text" name="service" placeholder="Description" required maxlength="255" autocomplete="off">
                                                            </div>
                                                            <div class="form-control" style="text-align: center;">
                                                                <span>Chọn kĩ năng bạn dạy:</span>
                                                            </div>
                                                            <div style="margin: 10px 0 0;" class="form-control">
                                                                <select name="skills" style="height: 100px" required multiple>
                                                                    <% for (int i = 0; i < skills.size(); i++) { %>
                                                                        <option value="<%= skills.get(i).getId() %>">
                                                                            <%= skills.get(i).getName() %>
                                                                        </option>
                                                                    <% } %>
                                                                </select>
                                                            </div>
                                                            <div class="form-control" style="text-align: center;">
                                                                <input type="number" name="money" step="1" min="1" placeholder="Giá Thuê Trên Slot">
                                                            </div>
                                                            <button type="submit"><span>Tạo CV</span></button>
            ...
            // Add 'in' class to the modal elements after a slight delay
            setTimeout(function () {
                document.body.lastChild.children[1].classList.add("in");
                document.body.lastChild.firstChild.classList.add("in");

                // Set up a click event to close the modal when clicking outside of it
...
function closeModal() {
    ...
    setTimeout(function () {
        document.body.style.cssText = 'background-color: rgb(233, 235, 238) !important; padding-top: 66px;';
        document.body.removeChild(document.body.lastChild);
        window.onclick = null;
    }, 100);
}

// Get references to elements for the cog and collapse functionality
